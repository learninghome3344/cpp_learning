...
inline void HelloRequest::set_message(const char* value) {
  ...
  message_->assign(value);
  // @@protoc_insertion_point(field_set_char:example.HelloRequest.message)
}
inline void HelloRequest::set_message(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:example.HelloRequest.message)
}
...
inline void HelloResponse::set_message(const char* value) {
  ...
  message_->assign(value);
  // @@protoc_insertion_point(field_set_char:example.HelloResponse.message)
}
inline void HelloResponse::set_message(const char* value, size_t size) {
  ...
  message_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:example.HelloResponse.message)
}
